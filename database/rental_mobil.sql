...
INSERT INTO `booking` (`id_booking`, `id_mobil`, `tgl_mulai`, `tgl_selesai`, `durasi`, `driver`, `status`, `email`, `pickup`, `tgl_booking`, `bukti_bayar`) VALUES
(1, 10, '2022-12-24', '2022-12-25', 2, 900000, 'Sudah Dibayar', 'nuge@gmail.com', 'Ambil Sendiri', '2022-12-23', '23122022220122alur.png'),
(2, 11, '2022-12-24', '2022-12-25', 2, 900000, 'Menunggu Pembayaran', 'nuge@gmail.com', 'Ambil Sendiri', '2022-12-23', ''),
(3, 12, '2022-12-24', '2022-12-25', 2, 900000, 'Menunggu Pembayaran', 'nuge@gmail.com', 'Ambil Sendiri', '2022-12-23', '');
...
INSERT INTO `cek_booking` (`id_cek`, `id_booking`, `id_mobil`, `tgl_booking`, `status`) VALUES
(1, 1, 10, '2022-12-24', 'Sudah Dibayar'),
(2, 1, 10, '2022-12-25', 'Sudah Dibayar'),
(3, 2, 11, '2022-12-24', 'Menunggu Pembayaran'),
(4, 2, 11, '2022-12-25', 'Menunggu Pembayaran'),
(5, 3, 12, '2022-12-24', 'Menunggu Pembayaran'),
(6, 3, 12, '2022-12-25', 'Menunggu Pembayaran');
...
(1, 'Rental Mobil Surya Rent Car', 'Suryarentcar@gmail.com', '08128272772');
...
(7, 'cecep wiranto', 'cecep@gmail.com', 'aff738ac6681f847310d38af54327734', '08128775161', 'Jakarta', '100420221057041d7a5f26-91e7-4f42-9f7d-0abd0a2a935b.jpg', '10042022105704067cef65-a559-415c-87ac-a3de45cbf16c.jpg', '2022-04-10 08:57:04', NULL),
(8, 'nuge', 'nuge@gmail.com', '202cb962ac59075b964b07152d234b70', '08123456789', 'makassar', '23122022133943atas.png', '23122022133943bab 3 ss.png', '2022-12-23 12:39:43', NULL);
...
--
ALTER TABLE `cek_booking`
  MODIFY `id_cek` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
