...
<title>Motor Car Rental Portal</title>
<!--Bootstrap -->
...
<?php 
$kode=$_GET['kode'];
$sql1 	= "SELECT booking.*,mobil.*, merek.* FROM booking,mobil,merek WHERE booking.id_mobil=mobil.id_mobil AND merek.id_merek=mobil.id_merek and booking.id_booking='$kode'";
	...
	<div class="user_profile_info">	
        ...
        <form method="post" action="update_sewa.php" name="sewa" onSubmit="return valid();" enctype="multipart/form-data"> 
			...
			<label>Kode Sewa</label>
				<input type="text" class="form-control" name="kode" value="TRX00<?php echo $result['id_booking'];?>"readonly>
            </div>
			<input type="hidden" class="form-control" name="vid"  value="<?php echo $vid;?>"required>
            <div class="form-group">
			<label>Mobil</label>
