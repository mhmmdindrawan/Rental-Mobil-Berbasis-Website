								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										$sqlsewa = "SELECT booking.*,mobil.*,merek.*,users.* FROM booking,mobil,merek,users WHERE booking.id_mobil=mobil.id_mobil
													AND merek.id_merek=mobil.id_merek AND users.email=booking.email ORDER BY booking.id_booking DESC";
										...
										<tr align="center">
											<td><?php echo $i;?></td>
											<td>TRX00<?php echo htmlentities($result['id_booking']);?></td>
											...
											<td>
												<a href="#myModal" data-toggle="modal" data-load-code="<?php echo $result['id_booking']; ?>" data-remote-target="#myModal .modal-body"><span class="glyphicon glyphicon-eye-open"></span></a>&nbsp;&nbsp;&nbsp;
											</td>
										</tr>
										<?php }?>
									</tbody>
