...
$sql1 	= "SELECT booking.*,mobil.*, merek.*, users.* FROM booking,mobil,merek,users WHERE booking.id_mobil=mobil.id_mobil 
			AND merek.id_merek=mobil.id_merek and booking.email=users.email and booking.id_booking='$kode'";
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Anugratis </h3></td>
					...
					<tr>
						<td class="text-center">Jl. Baji Gau 2 Kompleks RRI no 17 </td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td width="2%">:</td>
						<td>TRX00<?php echo $result['id_booking'];?></td>
					</tr>
					<tr>
						<td>Penyewa</td>
						<td>:</td>
