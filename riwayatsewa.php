		...
		?>
			<tr>
				...
				<?php 
					...
					?>
					<a href="booking_detail.php?kode=<?php echo $result['id_booking'];?>" class="glyphicon glyphicon-eye-open"></a>
					<?php 
					}else{
					?>
					<a href="booking_edit.php?kode=<?php echo $result['id_booking'];?>" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;
					<a href="booking_detail.php?kode=<?php echo $result['id_booking'];?>" class="glyphicon glyphicon-eye-open"></a>
					<?php }?>
				</td>
			</tr>
