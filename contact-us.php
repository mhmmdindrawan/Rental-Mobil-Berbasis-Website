...
?>
          <ul>
            <li>
              ...
              <div class="contact_info_m"><a href="https://goo.gl/maps/wb7cE5XFuuuE4sFz6"><?php   echo htmlentities($result['alamat_kami']); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><?php   echo htmlentities($result['email_kami']); ?></div>
            </li>
            <li>
